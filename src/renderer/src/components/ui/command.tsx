...
function CommandInput({
  ...
  return (
    <div
      ...
      className="border-stroke/70 flex h-10 items-center gap-2 border-b px-3.5"
    >
      <SearchIcon className="text-foreground/60 size-4 shrink-0" />
...
function CommandList({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) {
  return (
    <CommandPrimitive.List
      ...
      className={cn('max-h-[300px] overflow-x-hidden overflow-y-auto p-1.5 scroll-py-1', className)}
      {...props}
    />
  )
}
