...
let content = `<tg-emoji emoji-id='5258249368670073225'>❗️</tg-emoji>   <b><a href="https://github.com/coolcoala/vrp-vpn/releases/tag/${version}">New Release</a></b>\n\n`
...
for (const chat_id of chat_ids) {
  await axios.post(`https://api.telegram.org/bot${process.env.TELEGRAM_TOKEN}/sendMessage`, {
    ...
    link_preview_options: {
      is_disabled: false,
      url: 'https://github.com/coolcoala/vrp-vpn',
